...
| `windows.minesweeper:window` | the process — runs `view` on the shell's SDK (`butschster.windows.sdk:app`), hands it the first seed from the clock and fits the window to the level |
